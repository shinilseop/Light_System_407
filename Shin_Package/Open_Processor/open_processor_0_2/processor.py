...
import Shin_Package.open_processor_0_2.init_setter as initial
import Shin_Package.open_processor_0_2.datas as datas
import Shin_Package.open_processor_0_2.led_controller as controller
import Shin_Package.open_processor_0_2.printer as printer
import Shin_Package.open_processor_0_2.sensing as sensing
import Shin_Package.open_processor_0_2.illum_adder as illum_adder
...
if __name__ == '__main__':
    ...
    timer_data.to_csv("%s\\timer.csv"%datas.path)
    print(timer_data)
    print("timer save")
