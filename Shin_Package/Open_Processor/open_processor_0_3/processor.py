...
import Shin_Package.open_processor_0_3.init_setter as initial
import Shin_Package.open_processor_0_3.datas as datas
import Shin_Package.open_processor_0_3.led_controller as controller
import Shin_Package.open_processor_0_3.printer as printer
import Shin_Package.open_processor_0_3.sensing as sensing
import Shin_Package.open_processor_0_3.illum_adder as illum_adder
...
def process(start, case_num, change_time, illum_change_value):
    ...
    illum_add_thread = threading.Thread(target=illum_adder.illum_thread, args=(datas.illum_add,change_time, illum_change_value))
...
if __name__ == '__main__':
    ...
    for k in range(len(change_time)):
        ...
        datas.save_folder = save_folder_name[k]
        start = datetime.now()
        print('START :', start)
        # init led
