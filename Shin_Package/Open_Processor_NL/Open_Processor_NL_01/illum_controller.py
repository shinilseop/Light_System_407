...
import Shin_Package.Open_Processor_NL.Open_Processor_NL_01.led_controll as led
import Shin_Package.Open_Processor_NL.Open_Processor_NL_01.led_selecter as selecter
...
def illum_before_needs(II_illum, avg_illum):
    ...
    if ((not datas.more_illum_use_blind) | (datas.blind_lock > 0)):
        ...
        led_up(min_sensor, datas.sensor_influence_sum_part[min_sensor],
               datas.sensor_influence_value_sum_part[min_sensor],
               control_step)
