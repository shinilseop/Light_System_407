...
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.init_setter as initial
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.datas as datas
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.illum_controller as controller
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.printer as printer
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.sensing as sensing
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.illum_adder as illum_adder
from Shin_Package.Open_Processor_NL.Open_Processor_NL_02 import illum_controller
import Shin_Package.Open_Processor_NL.Open_Processor_NL_02.blind as blind
...
def process(start, case_num):
    ...
    while datas.isFinish:
        ...
        if control_object == 'led':
            ...
            if (not datas.can_control) & (datas.isJust_lock == 0):
                if (datas.cal_times >= 500) & (datas.blind_deg == -70):
