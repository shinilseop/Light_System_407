...
from Shin_Package.led_select_module_blind_not_include import datas
...
def blind_open():
    if datas.blind_deg < datas.blind_max:
        datas.blind_deg = datas.blind_deg + (2.8 * datas.blind_accel)
        if datas.blind_deg >= datas.blind_max:
            datas.blind_deg = datas.blind
...
def blind_close():
    ...
    if datas.blind_deg == datas.blind_min:
        getter_timeout_wrapped()
        # print(cmd_blind('1', 'R').decode(), end='')
        # print(cmd_blind('2', 'R').decode(), end='')
        ...
        if control_deg < datas.blind_min:
            control_deg = datas.blind_min
