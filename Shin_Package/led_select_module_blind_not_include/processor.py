...
import Shin_Package.led_select_module_blind_not_include.init_setter as initial
...
import Shin_Package.led_select_module_blind_not_include.printer as printer
import Shin_Package.led_select_module_blind_not_include.sensing as sensing
import Shin_Package.led_select_module_blind_not_include.illum_adder as illum_adder
...
if __name__ == '__main__':
    ...
    for acc in range(len(accel_list)):
        ...
        for lock_value in range(len(led_lock_range_list)):
            ...
            datas.cal_lux_time_limit = blind_limit_list[0]
